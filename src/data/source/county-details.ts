...
export const countyDetailSeed: CountyDetail[] = applySernecAlabamaCountyOverrides([
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Lee County has county-specific aquatic invasive evidence through structured USGS NAS records for Brazilian waterweed and parrot feather in county waterways.",
    headline: "Lee County has verified aquatic invasive records",
    countySummary:
      "Lee County moves out of the statewide-only tier in this pass. Federal aquatic invasive records now give the county direct evidence for both Brazilian waterweed and parrot feather, which is enough to support county-specific wording even though the source stack is still mostly water-focused.",
    summaryParagraphs: [
      "That makes Lee stronger than a generic statewide fallback, but the proof is still narrow. The current public evidence is strongest for aquatic invasive plants rather than a broad county invasive inventory.",
      "So the county detail should be direct about what is verified: named aquatic species in county waters, not a complete countywide invasive list.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Brazilian Waterweed Records",
        url: "https://nas.er.usgs.gov/queries/CollectionInfo.aspx?SpeciesID=1107",
        kind: "county-detection",
      },
      {
        label: "USGS NAS Parrot Feather Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Limestone County has strong county-specific aquatic invasive evidence through structured USGS NAS records for zebra mussel and wandering hydrilla tied to Browns Ferry and Wheeler Lake.",
    headline: "Limestone County has strong waterway evidence",
    countySummary:
      "Limestone County is one of the stronger counties in this chunk because the reviewed public sources include more than one county-specific aquatic invasive record. USGS NAS ties both zebra mussel and wandering hydrilla to named Limestone County waterway locations.",
    summaryParagraphs: [
      "That gives the county a cleaner evidence path than counties that only have statewide program context or a single narrow notice.",
      "The main limitation is still scope. These are strong aquatic signals, not a complete countywide invasive inventory across every habitat and taxonomic group.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
      ...
      {
        label: "USGS NAS Wandering Hydrilla Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Lowndes County has county-specific invasive evidence through structured USGS NAS bighead carp records from the Alabama River and Jones Bluff Reservoir corridor.",
    headline: "Lowndes County has a verified river corridor signal",
    countySummary:
      "Lowndes County no longer needs to sit in the statewide-only bucket. Federal aquatic records now give the county a direct invasive signal through bighead carp observations tied to the Alabama River corridor.",
    summaryParagraphs: [
      "That is enough for county-specific wording, but it is still a narrow species-specific source path rather than a broad county invasive inventory.",
      "An important contradiction stays preserved here: other Lowndes references may discuss statewide pest concern or local tree composition without actually confirming a county detection, so they should not be promoted into production evidence.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Bighead Carp Records",
        url: "https://nas.er.usgs.gov/queries/CollectionInfo.aspx?HUCNumber=31502&SpeciesID=551",
        kind: "county-detection",
      },
      {
        label: "ACES Down South on Emerald Ash Borer",
        url: "https://www.aces.edu/blog/topics/forestry-wildlife/down-south-on-the-farm-the-emerald-ash-borer-is-here/",
        kind: "county-extension",
      },
      {
        label: "Alabama Forestry Commission Invasive Species",
  ...
  },
  {
    ...
    evidenceLevel: "statewide-only",
    auditSummary:
      "Macon County was reviewed under the broader Alabama workflow, but the public sources checked in this pass still did not verify a county-specific invasive occurrence notice, list, or dashboard.",
    headline: "Macon County still leans on statewide sources",
    countySummary:
      "Macon County remains in the statewide-only tier after this pass. The reviewed official source stack confirmed statewide invasive-program coverage, but it did not surface a Macon-specific invasive detection or county list strong enough for sharper county claims.",
    summaryParagraphs: [
      "That does not mean Macon County lacks invasive species. It means the reviewed public source trail still stops short of county-specific invasive reporting we can cite with confidence.",
      "So the county detail should stay useful and readable without dressing statewide context up as a local invasive inventory.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Madison County has county-specific invasive evidence through Alabama Forestry Commission's 2025 emerald ash borer confirmation and a structured USGS NAS zebra mussel record.",
    headline: "Madison County has multiple verified invasive signals",
    countySummary:
      "Madison County moves into the county-specific tier with more than one verified signal. Alabama Forestry Commission publicly confirmed emerald ash borer there in 2025, and USGS NAS also ties zebra mussel to named Madison County waterway locations.",
    summaryParagraphs: [
      "That makes Madison stronger than counties in this audit that only have one narrow notice or statewide fallback.",
      "The scope is still limited, though. These records prove named county invasive signals, not a complete public county list across every invasive category.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Montgomery County has county-specific invasive evidence through structured USGS NAS records for narrow-leaved cattail and small water-clover, including records tied to Lagoon Park.",
    headline: "Montgomery County has verified aquatic plant records",
    countySummary:
      "Montgomery County moves into the county-specific tier with more than one structured aquatic invasive record. Federal occurrence data now ties both narrow-leaved cattail and small water-clover to named county locations, which is enough for county-specific wording instead of statewide fallback alone.",
    summaryParagraphs: [
      "That makes Montgomery stronger than a county with only generic statewide program context, but the source stack is still narrow and mostly aquatic.",
      "So the county detail should be clear about scope: real county-specific invasive-plant evidence exists, but it is not the same as a broad public county invasive inventory across every category.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Narrow-leaved Cattail Records",
        url: "https://nas.er.usgs.gov/queries/collectioninfo.aspx?SpeciesID=2679",
        kind: "county-detection",
      },
      {
        label: "USGS NAS Small Water-clover Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Morgan County has county-specific invasive evidence through structured silver carp records tied to Wheeler Reservoir and Decatur.",
    headline: "Morgan County has a verified fish signal",
    countySummary:
      "Morgan County no longer needs to sit in the statewide-only tier. Structured federal records and the Alabama aquatic nuisance species plan both point to silver carp in county waters around Wheeler Reservoir and Decatur.",
    summaryParagraphs: [
      "That gives Morgan County a clear county-specific invasive signal instead of relying only on statewide awareness.",
      "The current evidence is still narrower than a broad county inventory, though, so the county detail should stay direct about the fact that this is strong fish evidence rather than a full all-category list.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
      ...
      {
        label: "Alabama ANS Management Plan",
        url: "https://www.outdooralabama.com/sites/default/files/PDF%20documents/AL%20ANS%20Management%20Plan_FINAL_Oct_2021.pdf",
        kind: "statewide-program",
      },
      {
        label: "Alabama Forestry Commission Invasive Species",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Perry County has county-specific invasive evidence through an official Alabama Forestry Commission laurel wilt confirmation based on symptomatic sassafras samples.",
    headline: "Perry County has a verified forest-pathogen signal",
    countySummary:
      "Perry County moves into the county-specific tier because Alabama Forestry Commission confirmed laurel wilt there in its 2017 annual report. That gives the county a direct invasive-pathogen record instead of leaving it in statewide-only territory.",
    summaryParagraphs: [
      "The source is official and specific enough for county detail and a manual coverage fix, but it is still a narrative annual-report record rather than a structured county inventory.",
      "So the county detail should stay precise about what is proven: a real county-specific forest-pathogen signal, not a comprehensive public list of every invasive species in Perry County.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "AFC 2017 Annual Report",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Pickens County has county-specific invasive evidence through structured USGS NAS alligatorweed records tied to Aliceville Reservoir and the Tennessee-Tombigbee corridor.",
    headline: "Pickens County has a verified corridor signal",
    countySummary:
      "Pickens County moves out of the statewide-only tier in this pass. Federal occurrence data now gives the county a direct invasive signal through alligatorweed records linked to Aliceville Reservoir and the Tennessee-Tombigbee waterway corridor.",
    summaryParagraphs: [
      "That is strong enough for county-specific wording and a manual coverage fix.",
      "The main limit is breadth. The current public evidence is still tied to a waterway corridor and should not be presented as a full countywide invasive inventory across every habitat and category.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Alligatorweed Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Pike County has county-specific invasive evidence through structured USGS NAS small water-clover records tied to the Conecuh River and the Troy University Arboretum pond.",
    headline: "Pike County has a thin but verified aquatic signal",
    countySummary:
      "Pike County now clears the county-specific evidence bar, but just barely. The reviewed public source stack surfaced a structured federal record for small water-clover in county waters, which is enough for county-specific wording even though the overall source stack remains thin.",
    summaryParagraphs: [
      "That means Pike should no longer sit in the statewide-only bucket, but it also should not be described as if the county has a broad public invasive inventory.",
      "The strongest current evidence is narrow and aquatic-focused, so the county detail needs to stay especially explicit about that limitation.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Randolph County has county-specific invasive evidence through structured USGS NAS records for parrot feather.",
    headline: "Randolph County has a verified aquatic plant signal",
    countySummary:
      "Randolph County moves into the county-specific tier because federal occurrence data now ties parrot feather to the county. That gives Randolph stronger footing than statewide fallback alone, even though the current source stack remains narrow.",
    summaryParagraphs: [
      "The current county-specific proof is real but aquatic-focused, so Randolph should not be described as if it already has a broad public invasive inventory.",
      "This is the kind of thin but structured county evidence that improves map accuracy and county detail at the same time without overclaiming.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Russell County has county-specific invasive evidence through structured established records for water hyacinth tied to Seale.",
    headline: "Russell County has a verified pond signal",
    countySummary:
      "Russell County no longer needs to sit in the statewide-only bucket. Structured federal records now give the county a direct invasive signal through established water hyacinth in a named local site.",
    summaryParagraphs: [
      "That is enough for county-specific wording and a manual coverage fix, but the current evidence is still narrower than a broad county inventory.",
      "So the county detail should stay explicit about scope: this is a real local invasive record, not an all-category public list for Russell County.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Water Hyacinth Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "St. Clair County has county-specific invasive evidence through structured brittle waternymph records and prior official emerald ash borer documentation.",
    headline: "St. Clair County has multiple verified signals",
    countySummary:
      "St. Clair County is stronger than a thin single-record county. The reviewed sources include both structured aquatic invasive records and prior official emerald ash borer documentation, which gives the county more than one local invasive signal.",
    summaryParagraphs: [
      "That still is not the same as a broad public county inventory across all invasive categories, so the county detail should stay direct about scope.",
      "But it is enough to move St. Clair well past statewide fallback and into a more defensible county-specific tier.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Brittle Waternymph Records",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Shelby County has county-specific invasive evidence through structured hydrilla records and a secondary county-level pond-loach record.",
    headline: "Shelby County has multiple aquatic signals",
    countySummary:
      "Shelby County moves cleanly into the county-specific tier because the reviewed federal records include more than one local aquatic signal. Hydrilla is the stronger invasive record, and the secondary pond-loach record reinforces that the county is not relying on statewide fallback alone.",
    summaryParagraphs: [
      "The current source stack is still narrower than a broad public county inventory, so Shelby should not be written as if every invasive category has equivalent county-level reporting.",
      "Even so, the county now has enough structured local evidence to support sharper county-detail wording and a justified manual coverage update.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Hydrilla Record",
        url: "https://nas.er.usgs.gov/queries/SpecimenViewer.aspx?SpecimenID=229420",
        kind: "county-detection",
      },
      {
        label: "USGS NAS Pond Loach Record",
        url: "https://nas.er.usgs.gov/Queries/SpecimenViewer.aspx?SpecimenID=1695757",
        kind: "county-detection",
      },
      {
        label: "Alabama Forestry Commission Invasive Species",
  ...
  },
  {
    ...
    evidenceLevel: "county-specific",
    auditSummary:
      "Sumter County has county-specific invasive evidence through structured freshwater golden clam records with established occurrences in the Sucarnoochee and Alamuchee system.",
    headline: "Sumter County has a verified river-system signal",
    countySummary:
      "Sumter County no longer needs to sit in the statewide-only bucket. Federal occurrence data now gives the county a direct aquatic invasive signal through established freshwater golden clam records in local waters.",
    summaryParagraphs: [
      "That is enough for county-specific wording and a manual coverage fix, but the current source stack remains narrow and taxon-specific.",
      "So the county detail should stay careful about scope instead of implying Sumter already has a broad public invasive inventory across habitats and categories.",
    ],
    lastReviewedOn: "2026-04-21",
    resources: [
      {
        label: "USGS NAS Freshwater Golden Clam Records",
