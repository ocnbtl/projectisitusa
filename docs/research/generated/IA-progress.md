...
- Verified present: `1628`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `39754`
- Not researched: `206514`
- Determination coverage: `0.66%`
- Research coverage: `16.69%`
- Explicit outcome coverage: `16.6933%`
- Applicable protocol cells: `199`
- Current complete protocol cells: `102`
- Protocol completion: `57.79%`
- Current protocol completion: `51.26%`
- Evidence records: `1886`
- Research runs: `20`
- Rejection records: `107`
...
| Crow Garlic (`allium-vineale`) | plants | 0 | 99 | 0 |
| Alligatorweed (`alternanthera-philoxeroides`) | plants | 0 | 99 | 0 |
| Khakiweed (`alternanthera-pungens`) | plants | 0 | 99 | 0 |
| Sessile joyweed (`alternanthera-sessilis`) | plants | 0 | 99 | 0 |
| Purple amaranth (`amaranthus-blitum`) | plants | 0 | 99 | 0 |
| Largefruit amaranth (`amaranthus-deflexus`) | plants | 0 | 99 | 0 |
| African amaranth (`amaranthus-muricatus`) | plants | 0 | 99 | 0 |
| Mexican fruit fly (`anastrepha-ludens`) | insects | 0 | 99 | 0 |
...
| GBIF preserved specimen records | operational | 2026-08-18T23:58:30.364Z | 212 | 89 |
