...
| --- | --- | ---: | ---: | ---: |
| Rock pigeon (`columba-livia`) | wildlife | 18 | 0 | 1 |
| Eurasian collared dove (`streptopelia-decaocto`) | wildlife | 15 | 0 | 1 |
| European Starling (`sturnus-vulgaris`) | wildlife | 11 | 0 | 1 |
| House sparrow (`passer-domesticus`) | wildlife | 9 | 0 | 1 |
