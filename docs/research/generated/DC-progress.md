...
- Species: `18`
- Counties: `1`
- County-species pairs: `18`
- Verified present: `13`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `5`
- Not researched: `0`
- Determination coverage: `72.22%`
...
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 1 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 1 | 2 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 1 | 2 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 0 | 2 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 0 | 2 |
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 0 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 0 | 2 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 0 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 0 | 2 |
...
| Faucet snail (`bithynia-tentaculata`) | wildlife | 0 | 0 | 0 |
| Asiatic Clam (`corbicula-fluminea`) | wildlife | 0 | 0 | 0 |
| Common Carp (`cyprinus-carpio`) | wildlife | 0 | 0 | 0 |
| Yellow Flag Iris (`iris-pseudacorus`) | plants | 0 | 0 | 0 |
| Copepod (`mesocyclops-pehpeiensis`) | wildlife | 0 | 0 | 0 |
...
| USFS Alien Forest Pest Explorer | operational | 2026-07-26T03:59:30.000Z | 8 | 13 |
