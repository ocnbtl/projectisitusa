...
- Species: `18`
- Counties: `16`
- County-species pairs: `288`
- Verified present: `74`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `214`
- Not researched: `0`
- Determination coverage: `25.69%`
...
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 16 | 2 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 16 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 16 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 16 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 16 | 2 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 16 | 2 |
...
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 12 | 2 |
| Watercress (`nasturtium-officinale`) | plants | 0 | 11 | 0 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 5 | 2 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 1 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 1 | 2 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 1 | 2 |
