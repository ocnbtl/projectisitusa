...
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `10944`
- Not researched: `205668`
- Determination coverage: `0.57%`
- Research coverage: `5.59%`
- Explicit outcome coverage: `5.5911%`
- Applicable protocol cells: `116`
- Current complete protocol cells: `89`
- Protocol completion: `87.93%`
- Current protocol completion: `76.72%`
- Evidence records: `2733`
- Research runs: `12`
...
| Khakiweed (`alternanthera-pungens`) | plants | 0 | 87 | 0 |
| Sessile joyweed (`alternanthera-sessilis`) | plants | 0 | 87 | 0 |
| Purple amaranth (`amaranthus-blitum`) | plants | 0 | 87 | 0 |
| Largefruit amaranth (`amaranthus-deflexus`) | plants | 0 | 87 | 0 |
| African amaranth (`amaranthus-muricatus`) | plants | 0 | 87 | 0 |
| Mexican fruit fly (`anastrepha-ludens`) | insects | 0 | 87 | 0 |
| Asian Longhorned Beetle (`asian-longhorned-beetle`) | insects | 0 | 87 | 0 |
| Sweet Vernalgrass (`anthoxanthum-odoratum`) | plants | 0 | 87 | 0 |
...
| USDA NRCS PLANTS county distribution | operational | 2026-08-15T23:58:51.277Z | 285 | 40 |
