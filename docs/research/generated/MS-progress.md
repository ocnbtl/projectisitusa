...
- Species: `18`
- Counties: `82`
- County-species pairs: `1476`
- Verified present: `170`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `1306`
- Not researched: `0`
- Determination coverage: `11.52%`
...
| --- | --- | ---: | ---: | ---: |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 82 | 2 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 82 | 2 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 82 | 2 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 82 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 82 | 2 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 81 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 81 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 79 | 2 |
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 76 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 76 | 2 |
| Silver Carp (`hypophthalmichthys-molitrix`) | wildlife | 0 | 74 | 0 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 73 | 2 |
| Water Hyacinth (`eichhornia-crassipes`) | plants | 0 | 71 | 0 |
| Nutria (`nutria`) | wildlife | 0 | 64 | 0 |
| Parrot Feather (`myriophyllum-aquaticum`) | plants | 0 | 64 | 0 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 63 | 2 |
| Alligatorweed (`alternanthera-philoxeroides`) | plants | 0 | 50 | 0 |
