...
- Species: `18`
- Counties: `5`
- County-species pairs: `90`
- Verified present: `38`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `52`
- Not researched: `0`
- Determination coverage: `42.22%`
...
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 5 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 5 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 5 | 2 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 5 | 2 |
| Sea vomit tunicate (`didemnum-vexillum`) | wildlife | 0 | 3 | 0 |
| Brazilian Waterweed (`egeria-densa`) | plants | 0 | 3 | 0 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 2 | 2 |
| Eurasian Watermilfoil (`myriophyllum-spicatum`) | plants | 0 | 2 | 0 |
| Asiatic Clam (`corbicula-fluminea`) | wildlife | 0 | 1 | 0 |
| Asian shore crab (`hemigrapsus-sanguineus`) | wildlife | 0 | 1 | 0 |
