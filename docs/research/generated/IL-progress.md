...
- Species: `18`
- Counties: `102`
- County-species pairs: `1836`
- Verified present: `629`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `1207`
- Not researched: `0`
- Determination coverage: `34.26%`
...
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 101 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 99 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 99 | 2 |
| Purple Loosestrife (`lythrum-salicaria`) | plants | 0 | 74 | 0 |
| Brittle Waternymph (`najas-minor`) | plants | 0 | 63 | 0 |
| Creeping yellowcress (`rorippa-sylvestris`) | plants | 0 | 47 | 0 |
| Narrowleaf Cattail (`typha-angustifolia`) | plants | 0 | 46 | 0 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 30 | 2 |
| Moneywort (`lysimachia-nummularia`) | plants | 0 | 24 | 0 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 12 | 2 |
