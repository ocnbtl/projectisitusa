...
- Verified present: `982`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `4016`
- Not researched: `250410`
...
- Evidence records: `990`
- Research runs: `7`
- Rejection records: `14`
...
| --- | --- | ---: | ---: | ---: |
| Sticky snakeroot (`ageratina-adenophora`) | plants | 102 | 0 | 0 |
| Sessile joyweed (`alternanthera-sessilis`) | plants | 102 | 0 | 0 |
| Capeweed (`arctotheca-calendula`) | plants | 102 | 0 | 0 |
| Onionweed (`asphodelus-fistulosus`) | plants | 102 | 0 | 0 |
| Animated oat (`avena-sterilis`) | plants | 102 | 0 | 0 |
| Feathered mosquitofern (`azolla-pinnata`) | plants | 102 | 0 | 0 |
| Jio (`commelina-benghalensis`) | plants | 102 | 0 | 0 |
| Common crupina (`crupina-vulgaris`) | plants | 102 | 0 | 0 |
| Anchored water hyacinth (`eichhornia-azurea`) | plants | 102 | 0 | 0 |
| Southern threecornerjack (`emex-australis`) | plants | 102 | 0 | 0 |
| Spiny threecornerjack (`emex-spinosa`) | plants | 102 | 0 | 0 |
| Geraldton carnation weed (`euphorbia-terracina`) | plants | 102 | 0 | 0 |
| Professor-weed (`galega-officinalis`) | plants | 102 | 0 | 0 |
| Giant Hogweed (`giant-hogweed`) | plants | 102 | 0 | 0 |
| Hydrilla (`hydrilla`) | plants | 102 | 0 | 0 |
| Indian swampweed (`hygrophila-polysperma`) | plants | 102 | 0 | 0 |
| Cogongrass (`imperata-cylindrica`) | plants | 102 | 0 | 0 |
| Swamp morning-glory (`ipomoea-aquatica`) | plants | 102 | 0 | 0 |
| Asian marshweed (`limnophila-sessiliflora`) | plants | 102 | 0 | 0 |
| African boxthorn (`lycium-ferocissimum`) | plants | 102 | 0 | 0 |
| Small-leaf climbing fern (`lygodium-microphyllum`) | plants | 102 | 0 | 0 |
| Mile-a-minute (`mikania-micrantha`) | plants | 102 | 0 | 0 |
| Serrated tussock grass (`nassella-trichotoma`) | plants | 102 | 0 | 0 |
| Illyrian cottonthistle (`onopordum-illyricum`) | plants | 102 | 0 | 0 |
| Ducklettuce (`ottelia-alismoides`) | plants | 102 | 0 | 0 |
...
| USFS Alien Forest Pest Explorer | operational | 2026-07-26T03:59:30.000Z | 373 | 13 |
| USDA Forest Service FIA DataMart invasive plant tables | operational | 2026-07-26T13:44:30.000Z | 361 | 33 |
