...
- Species: `18`
- Counties: `77`
- County-species pairs: `1386`
- Verified present: `74`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `1312`
- Not researched: `0`
- Determination coverage: `5.34%`
...
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 76 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 75 | 2 |
| Yellow Floating Heart (`nymphoides-peltata`) | plants | 0 | 74 | 0 |
| Curly-Leaf Pondweed (`potamogeton-crispus`) | plants | 0 | 73 | 0 |
| Brazilian Waterweed (`egeria-densa`) | plants | 0 | 72 | 0 |
| Bighead Carp (`hypophthalmichthys-nobilis`) | wildlife | 0 | 71 | 0 |
| Spiny waterflea (`daphnia-lumholtzi`) | wildlife | 0 | 64 | 0 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 58 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 56 | 2 |
