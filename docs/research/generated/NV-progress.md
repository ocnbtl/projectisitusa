...
- Species: `18`
- Counties: `17`
- County-species pairs: `306`
- Verified present: `7`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `299`
- Not researched: `0`
- Determination coverage: `2.29%`
- Research coverage: `100.00%`
- Explicit outcome coverage: `100.0000%`
- Applicable protocol cells: `31`
- Current complete protocol cells: `5`
- Protocol completion: `58.06%`
- Current protocol completion: `16.13%`
- Evidence records: `7`
- Research runs: `6`
- Rejection records: `3`
...
| --- | --- | ---: | ---: | ---: |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 17 | 2 |
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 17 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 17 | 2 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 17 | 2 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 17 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 17 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 17 | 2 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 17 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 17 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 17 | 2 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 17 | 2 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 17 | 2 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 16 | 2 |
| Curly-Leaf Pondweed (`potamogeton-crispus`) | plants | 0 | 16 | 0 |
| New Zealand Mud Snail (`potamopyrgus-antipodarum`) | wildlife | 0 | 16 | 0 |
| Asian tapeworm (`schyzocotyle-acheilognathi`) | wildlife | 0 | 16 | 0 |
| Spotted Tilapia (`tilapia-mariae`) | wildlife | 0 | 16 | 0 |
| Eurasian Watermilfoil (`myriophyllum-spicatum`) | plants | 0 | 15 | 0 |
...
| USGS NAS | operational | 2026-07-16T09:29:03.000Z | 6 | 5 |
