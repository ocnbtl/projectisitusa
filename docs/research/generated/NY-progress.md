...
- Species: `18`
- Counties: `62`
- County-species pairs: `1116`
- Verified present: `528`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `588`
- Not researched: `0`
- Determination coverage: `47.31%`
...
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 61 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 61 | 2 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 55 | 2 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 52 | 2 |
...
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 9 | 2 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 8 | 2 |
