...
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 21 | 1 |
...
| Punktree (`melaleuca-quinquenervia`) | plants | 0 | 21 | 0 |
| Chinaberry Tree (`melia-azedarach`) | plants | 0 | 21 | 0 |
| Princess Tree (`paulownia-tomentosa`) | plants | 0 | 21 | 0 |
| Saltcedar (`tamarix-ramosissima`) | plants | 0 | 21 | 0 |
| Chinese Tallow (`triadica-sebifera`) | plants | 0 | 21 | 0 |
| Siberian Elm (`ulmus-pumila`) | plants | 0 | 21 | 0 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 20 | 1 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 20 | 1 |
| Bull Thistle (`cirsium-vulgare`) | plants | 0 | 20 | 0 |
| Russian Olive (`elaeagnus-angustifolia`) | plants | 0 | 20 | 0 |
| Dames rocket (`hesperis-matronalis`) | plants | 0 | 20 | 0 |
| Tatarian Honeysuckle (`lonicera-tatarica`) | plants | 0 | 20 | 0 |
| Wartremoving herb (`murdannia-keisak`) | plants | 0 | 20 | 0 |
| Japanese meadowsweet (`spiraea-japonica`) | plants | 0 | 20 | 0 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 19 | 1 |
| Spotted knapweed (`centaurea-stoebe-ssp-micranthos`) | plants | 0 | 19 | 0 |
