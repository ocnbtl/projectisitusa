...
- Species: `18`
- Counties: `21`
- County-species pairs: `378`
- Verified present: `136`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `242`
- Not researched: `0`
- Determination coverage: `35.98%`
...
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 20 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 20 | 2 |
| Wartremoving herb (`murdannia-keisak`) | plants | 0 | 20 | 0 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 19 | 2 |
| European waterclover (`marsilea-quadrifolia`) | plants | 0 | 17 | 0 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 16 | 2 |
| Pond water-starwort (`callitriche-stagnalis`) | plants | 0 | 16 | 0 |
| Parrot Feather (`myriophyllum-aquaticum`) | plants | 0 | 14 | 0 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 6 | 2 |
| Asiatic Clam (`corbicula-fluminea`) | wildlife | 0 | 6 | 0 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 4 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 0 | 2 |
