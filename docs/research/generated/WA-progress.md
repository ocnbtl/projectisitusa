...
| French broom (`genista-monspessulana`) | plants | 39 | 0 | 0 |
| English Ivy (`hedera-helix`) | plants | 39 | 0 | 0 |
| Atlantic ivy (`hedera-hibernica`) | plants | 39 | 0 | 0 |
| Orange Hawkweed (`hieracium-aurantiacum`) | plants | 39 | 0 | 0 |
| Meadow hawkweed (`hieracium-caespitosum`) | plants | 39 | 0 | 0 |
| Common St. John's Wort (`hypericum-perforatum`) | plants | 39 | 0 | 0 |
| English holly (`ilex-aquifolium`) | plants | 39 | 0 | 0 |
| Himalayan Balsam (`impatiens-glandulifera`) | plants | 39 | 0 | 0 |
