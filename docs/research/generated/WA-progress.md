...
- Species: `18`
- Counties: `39`
- County-species pairs: `702`
- Verified present: `128`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `574`
- Not researched: `0`
- Determination coverage: `18.23%`
...
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 39 | 2 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 39 | 2 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 39 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 39 | 2 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 39 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 39 | 2 |
| Japanese Beetle (`popillia-japonica`) | insects | 0 | 39 | 2 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 39 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 38 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 38 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 38 | 2 |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 33 | 2 |
| Nutria (`nutria`) | wildlife | 0 | 25 | 0 |
| Pond water-starwort (`callitriche-stagnalis`) | plants | 0 | 22 | 0 |
| Brazilian Waterweed (`egeria-densa`) | plants | 0 | 22 | 0 |
| Asiatic Clam (`corbicula-fluminea`) | wildlife | 0 | 4 | 0 |
| Eurasian Watermilfoil (`myriophyllum-spicatum`) | plants | 0 | 3 | 0 |
