...
- Species: `18`
- Counties: `100`
- County-species pairs: `1800`
- Verified present: `390`
- Verified absent: `0`
- Not detected: `0`
- Researched unresolved: `1410`
- Not researched: `0`
- Determination coverage: `21.67%`
...
| --- | --- | ---: | ---: | ---: |
| Peach twig borer (`anarsia-lineatella`) | insects | 0 | 100 | 2 |
| Camphor scale (`aspidiotus-duplex`) | insects | 0 | 100 | 2 |
| Mimosa webworm (`homadaula-albizziae`) | insects | 0 | 96 | 2 |
| Purple Loosestrife (`lythrum-salicaria`) | plants | 0 | 96 | 0 |
| Sacred lotus (`nelumbo-nucifera`) | plants | 0 | 96 | 0 |
| Asian Chestnut Gall Wasp (`dryocosmus-kuriphilus`) | insects | 0 | 95 | 2 |
| Cottony cushion scale (`icerya-purchasi`) | insects | 0 | 95 | 2 |
| Nutria (`nutria`) | wildlife | 0 | 95 | 0 |
| Eurasian Watermilfoil (`myriophyllum-spicatum`) | plants | 0 | 93 | 0 |
| Chinese mysterysnail (`cipangopaludina-chinensis`) | wildlife | 0 | 89 | 0 |
| Laurel wilt (`raffaelea-lauricola`) | fungi-diseases | 0 | 86 | 2 |
| Dutch elm disease (`ophiostoma-ulmi`) | fungi-diseases | 0 | 81 | 2 |
| Phytophthora Root Rot (`phytophthora-cinnamomi`) | fungi-diseases | 0 | 72 | 2 |
| Dogwood Anthracnose (`discula-destructiva`) | fungi-diseases | 0 | 69 | 2 |
| Chestnut Blight (`cryphonectria-parasitica`) | fungi-diseases | 0 | 54 | 2 |
| Butternut Canker Fungus (`ophiognomonia-clavigignenti-juglandacearum`) | fungi-diseases | 0 | 54 | 2 |
| Emerald Ash Borer (`emerald-ash-borer`) | insects | 0 | 39 | 2 |
