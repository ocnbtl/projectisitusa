...
| USGS North American Breeding Bird Survey, DOI: https://doi.org/10.5066/P144YU3S | Official route-start survey-detection support for exact current-catalog bird taxa | `src/data/source/bbs-alabama-route-start-birds-snapshot.json`, `src/data/research/national-acquisition-plans/usgs-bbs-tx-route-start-pilot-v1.json`, `src/data/research/national-acquisition-plans/usgs-bbs-il-route-start-tranche-v1.json`, `src/data/research/runs/20260828T030700Z__usgs-bbs__f2aa993e6e33/`, `src/data/research/runs/20260828T061928Z__usgs-bbs__154ba0c33ef3/`, `public/generated/research/TX/`, `public/generated/research/IL/` | The legacy Alabama importer and registered `usgs-bbs-route-start@1.1.1` adapter verify the 2026 ScienceBase release identity plus exact byte counts and MD5 checksums for `Routes.csv`, `SpeciesList.csv`, `Weather.csv`, and `50-StopData.zip`; require exact current-catalog binomials and exact BBS AOU matches; filter to United States `RunType=1` standard runs with positive `Stop1` counts; and require route-start coordinates to resolve inside exactly one committed active county. The complete national scan reviewed `10` catalog bird species, found `7` exact BBS matches, resolved `4,453` of `4,458` United States routes, screened `4,551,591` archive rows, retained `5,322` positive standard-run Stop 1 rows, and identified `1,548` gross / `1,431` net county-species pairs before either new tranche. The Texas tranche retained `426` rows and moved `116` unique pairs from not researched to verified present. A fresh post-Texas rescan measured `1,315` remaining net pairs; the Illinois tranche then retained `388` rows and moved `87` more unique pairs across `48` counties (`44` House Sparrow, `29` European Starling, `11` Eurasian Collared-Dove, `2` Rock Pigeon, and `1` Mute Swan). All assertions carry topology and coordinate-set receipts. The earlier Alabama pilot retained `77` rows and produced `37` gross / `0` net pairs. Treat every BBS assertion as sampled point presence only, never countywide presence, later-stop county evidence, route-total evidence, non-detection, absence, establishment proof, or complete bird inventory coverage. | Alabama accessed `2026-06-16`; current release, Texas tranche, and Illinois tranche accessed `2026-08-28` UTC |
