...
| USDA APHIS PPQ Federal Quarantine county FeatureServer, https://services7.arcgis.com/2C1NQ7u6M6SXoa8p/arcgis/rest/services/PPQ_GIS_Federal_Quarantine_AGOL_EDIT_Feature_Layer_view/FeatureServer/1 | County-level Alabama regulatory quarantine support for exact catalog-matched pest and pathogen programs | `src/data/source/county-presence-snapshot.json`, `src/data/generated/presence.json`, `public/generated/presence.json` | `scripts/import-county-presence.ts` queries active Alabama quarantine rows, maps reviewed program names to exact catalog species, and imports Asian citrus psyllid, red imported fire ant, and sweet orange scab county coverage | Accessed and merged on `2026-04-25` |
