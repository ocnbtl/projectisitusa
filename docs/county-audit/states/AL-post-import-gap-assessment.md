...
| Category balance | Alabama has only `1` live mapped insect and `2` live mapped fungi or diseases | APHIS, ADAI, USFS, AFC forest-health layers, and state pest notices | High priority for future source-family work. |
